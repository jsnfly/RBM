...
load_path = '/home/jonas/HDD/data/unwindowed/5_second_intervals_pre_emph09_shuffled/'
...
save_path = os.path.join(save_path, 'convnet_test2_{}timesteps_{}ls_{}bs'.format(num_time_steps, LSTM_size, batch_size))
