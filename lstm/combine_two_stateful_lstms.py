...
forward_train_outputs1 = all_train_outputs
forward_val_outputs1 = all_val_outputs
...
# reflip
reverse_train_outputs1 = [np.flip(train_samples, axis=0) for train_samples in all_train_outputs]
reverse_val_outputs1 = [np.flip(val_samples, axis=0) for val_samples in all_val_outputs]
#########################################################
...
forward_train_outputs2 = all_train_outputs
forward_val_outputs2 = all_val_outputs
...
# reflip
reverse_train_outputs2 = [np.flip(train_samples, axis=0) for train_samples in all_train_outputs]
reverse_val_outputs2 = [np.flip(val_samples, axis=0) for val_samples in all_val_outputs]
#########################################################
...
model.add(Dense(num_labels, input_shape=(2*lstm1_size + 2*lstm2_size,)))
